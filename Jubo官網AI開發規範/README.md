...
| **`18_無障礙稽核與90%達標計畫.md`** | 156 頁全站無障礙實測、JA11Y-23 計分模型、A–E 五組修正計畫與達標預測 | **動 alt／表單／landmark／heading／顏色對比／動效前** |
| `../custom-code/slater-selectors.md` | Slater 外部 CSS/JS 鎖住的 class（**不可改名**） | 改任何 class 名之前 |
| `../custom-code/a11y-audit/` | 上面那份報告的量測腳本與 2026-09-15 基準快照，可重跑做前後對照 | 驗收無障礙修正時 |
